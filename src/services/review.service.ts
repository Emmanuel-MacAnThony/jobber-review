...
import { IReviewDocument, IReviewMessageDetails } from '@Emmanuel-MacAnThony/jobber-shared';
...
const addReview = async (data: IReviewDocument): Promise<IReviewDocument> => {
  ...
  const { gigId, reviewerId, reviewerImage, sellerId, review, rating, orderId, reviewType, reviewerUsername, country } = data as unknown as any;
